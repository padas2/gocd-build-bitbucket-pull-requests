...
public class Constants {
    ...
    public final static String SCM_CONFIGURATION = "scm-configuration";
    ...
    public static final String VALIDATE_SCM_CONFIGURATION = "validate-scm-configuration";
    public static final String CHECK_SCM_CONNECTION = "check-scm-connection";
    public static final String LATEST_REVISION = "latest-revision";
    public static final String LATEST_REVISIONS_SINCE = "latest-revisions-since";
